...
func sortPlayers(by height: Int, by exp: Bool) -> Int {
    let averageHeight = 0.00
    let isExperienced = Bool()
    
    for playerHeight in players.count {
        if averageHeight = playerHeight["height"] as! Double / 1.5 {
